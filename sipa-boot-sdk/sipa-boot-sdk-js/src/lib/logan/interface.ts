...
export enum ResultMsg {
  ...
  REPORT_LOG_SUCCESS = "Report success",
 ...
 */
export interface LogSuccessHandler {
 ...
 *
 * @param reportUrl The server address to accept logs. The reportUrl set in report() method will override this.
 ...
 * @param successHandler This method will be invoked if one log is saved locally.
 *
 */
export interface GlobalConfig {
  ...
  successHandler?: LogSuccessHandler
}
...
export interface ReportXHROpts {
  ...
  responseDealer?: {
    (xhrResponseText: any): {
      resultMsg: ResultMsg.REPORT_LOG_SUCCESS | ResultMsg.REPORT_LOG_FAIL
      desc?: string
    }
  }
}
 ...
 * @param fromDayString Logs that saved from this day (this day is not exclusive) will be uploaded.
 * @param toDayString Logs that saved until this day (this day is not exclusive) will be uploaded.
...
export interface ReportConfig {
  ...
  xhrOptsFormatter?: {
    (
      logItemStrings: string[],
      logPageNo: number /* logPageNo starts from 1 */,
      logDayString: string
    ): ReportXHROpts
  }
  /**
