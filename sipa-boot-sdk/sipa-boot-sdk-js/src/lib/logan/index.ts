...
import * as LoganUtil from "./lib/utils"
...
function reportParamChecker(reportConfig: ReportConfig): never | void {
  ...
  if (typeof reportConfig.incrementalReport === "undefined") {
    reportConfig.incrementalReport = true
  }
}

function logParamChecker(
  logType: number,
...
function standardLog(
  ...
  try {
    logParamChecker(logType, encryptVersion)
  } catch (e) {
