...
app.service('SystemServiceV2', ['$http', function ($http) {
  this.queryMachineRules = function (app) {
    ...
    return $http({
      url: 'v2/system/rules.json', params: param, method: 'GET'
    });
  };
  ...
  this.newRule = function (rule) {
    ...
    return $http({
      url: 'v2/system/new.json', params: param, method: 'GET'
    });
  };
  ...
  this.saveRule = function (rule) {
    ...
    return $http({
      url: 'v2/system/save.json', params: param, method: 'GET'
    });
  };

  this.deleteRule = function (rule) {
    var param = {
      id: rule.id, app: rule.app
    };

    return $http({
      url: 'v2/system/delete.json', params: param, method: 'GET'
    });
  };
}]);
